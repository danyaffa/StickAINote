      ...
      >
        ...
        >
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            {/* FIXED: Removed invalid 'md' property */}
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            {isVip ? (
              ...
              <a href="https://buy.stripe.com/bJe7sL6cC9mgdDt11a4F20i" target="_blank" rel="noopener noreferrer" style={{ color: "#4ade80", fontWeight: "bold" }}>Subscribe</a>
            )}
          </div>
        </header>
